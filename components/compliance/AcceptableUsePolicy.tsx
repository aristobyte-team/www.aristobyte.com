  ...
  <div className="compliance">
    <div className="compliance__container">
      <div className="compliance__document">
        ...
        <h2 className="compliance__title-small">WHO WE ARE</h2>
        <p className="compliance__par">
          We are AristoByte (&quot;Company,&quot; &quot;we,&quot;
          &quot;us,&quot; or &quot;our&quot;) a company registered in Poland at
          Cracow, Lesse Poland. We operate, as well as any other related
          products and services that refer or link to this Policy (collectively,
          the &quot;Services&quot;).
        </p>
        <h2 className="compliance__title-small">USE OF THE SERVICES</h2>
        <p className="compliance__par">
